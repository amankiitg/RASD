\begin{table}[h]
\centering
\caption{M3 ablation results (64k context, 8$\times$A100-SXM4-40GB). Mean and 95\% bootstrap CI per level over 3 seeds; horizontal rules separate the five sweep axes. Deterministic early-EOS rows with tokens\_generated $<$ 20 are excluded; see \S Error Analysis.}
