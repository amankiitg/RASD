...
the qualitative comparison in \S\ref{sec:results-qualitative}
...
\item \textbf{Per-round acceptance traces}
  (Fig.~\ref{fig:alpha}) --- one JSONL sidecar per run at
...
The R6.5 ablation is the post-fix re-run after the verify-loop
defects identified on 2026-04-16 were resolved
