...
context. \emph{Third}, a profiler measurement on the speculator
rank shows that communication is $\leq 1.2\%$ of wall across the
matrix, ruling out comm-overlap as the mechanism behind the
moderate-context speedup. \emph{Fourth}, as a capability result:
